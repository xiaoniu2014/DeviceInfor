#
#  Be sure to run `pod spec lint DeviceInfor.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "hongw"
  # s.authors            = { "hongw" => "116445168@qq.com" }
  # s.social_media_url   = "http://twitter.com/hongw"
